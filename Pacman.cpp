...
void Pacman::draw(bool i_victory, sf::RenderWindow& i_window)
{
    ...
    if (1 == dead || 1 == i_victory)
    {
        if (animation_timer < PACMAN_DEATH_FRAMES * PACMAN_ANIMATION_SPEED)
        {
            ...
            texture.loadFromFile("C:/Users/kakas/CLionProjects/untitled9/Resources/PacmanDeath.png");
    ...
    {
        texture.loadFromFile("C:/Users/kakas/CLionProjects/untitled9/Resources/Pacman.png");
